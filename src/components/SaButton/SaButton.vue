...
const buttonVariants = tv({
  base: "px-4 py-2 uppercase font-semibold duration-200 inline-flex items-center justify-center gap-2",
  variants: {
    size: {
      sm: "text-sm",
      lg: "text-lg",
...
<template>
  <button
    v-bind="$attrs"
    :class="buttonVariants({ size, color, disabled: disabled || loading })"
